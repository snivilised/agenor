# 🌀 jaywalk: ___rx observable concurrent directory walker___
...
[![Coverage Status](https://coveralls.io/repos/github/snivilised/jaywalk/badge.svg?branch=main)](https://coveralls.io/github/snivilised/jaywalk?branch=main&kill_cache=1)
...
- implemented with [🐍 Cobra](https://cobra.dev/) cli framework, assisted by [🍎 Mamba](https://github.com/snivilised/mamba)
