...
// func FindIndexOf[T any](collection []T, predicate func(item T) bool) (T, int, bool) { //nolint:gocritic // foo
// 	for i, item := range collection {
// 		if predicate(item) {
// 			return item, i, true
// 		}
...
// It returns -1 and false if the element is not found.
// func FindLastIndexOf[T any](collection []T, predicate func(item T) bool) (T, int, bool) { //nolint:gocritic // foo
// 	length := len(collection)
...
// 	return collection[rand.Intn(size)] //nolint:gosec // foo
// }
...
// 		index := rand.Intn(size - i) //nolint:gosec // foo
// 		results = append(results, cpy[index])

// 		// Removes element.
// 		// It is faster to swap with last element and remove it.
// 		cpy[index] = cpy[copyLength-1]
// 		cpy = cpy[:copyLength-1]
// 	}
